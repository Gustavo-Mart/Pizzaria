...
class Pizzaria:
    ...
    def exibir_cardapio(self):
        ...
        for sabor, ingredientes in self.cardapio.items():
            print(f"\033[32m{sabor}......... {', '.join(ingredientes)}\033[0m")# join serve para colocar a virgula, entre os ingredientes e o \033 é para colorir o texto

        print("\n\033[31m--------PIZZAS DOCES--------")
        for sabor, ingredientes in self.cardapio_doces.items():
            print(f"\033[31m{sabor}......... {', '.join(ingredientes)}\033[0m")# join serve para colocar a virgula, entre os ingredientes e o \033 é para colorir o texto
